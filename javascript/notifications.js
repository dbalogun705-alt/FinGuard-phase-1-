...
notifyTabs.forEach(function (tab) {
  tab.addEventListener("click", function () {
    ...
    notifyItems.forEach(function (item) {
      ...
      if (selectedFilter === "all" || notificationType === selectedFilter) {
...
const notifyOlderBtn = document.getElementById("notifyOlderBtn");

const notifyOlderContent = document.getElementById("notifyOlderContent");

notifyOlderBtn.addEventListener("click", function () {
  if (notifyOlderContent.style.display === "block") {
...
notifyItems.forEach(function (item) {
  item.addEventListener("click", function () {
    ...
    if (title) {
      console.log("Notification selected: " + title.textContent);
    }
  });
});
